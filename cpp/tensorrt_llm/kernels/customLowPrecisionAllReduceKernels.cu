...
#include "customLowPrecisionAllReduceKernels.h"
...
template <typename T, typename QUANT_T, int RANKS_PER_NODE>
void lowPrecisionAllReduceDispatchRanksPerNode(
    AllReduceStrategyType algo, kernels::LowPrecisionAllReduceParams& params, cudaStream_t stream)
{
...
template <typename T>
void lowPrecisionAllReduceDispatchType(
    kernels::LowPrecisionAllReduceParams& param, AllReduceStrategyType strat, cudaStream_t stream)
{
#ifdef ENABLE_FP8
    switch (param.ranks_per_node)
    {
    case 2: lowPrecisionAllReduceDispatchRanksPerNode<T, __nv_fp8_e4m3, 2>(strat, param, stream); break;
    case 4: lowPrecisionAllReduceDispatchRanksPerNode<T, __nv_fp8_e4m3, 4>(strat, param, stream); break;
    case 8: lowPrecisionAllReduceDispatchRanksPerNode<T, __nv_fp8_e4m3, 8>(strat, param, stream); break;
...
LowPrecisionAllReduceParams LowPrecisionAllReduceParams::deserialize(
    size_t tpSize, size_t tpRank, nvinfer1::DataType dataType, int token_num, int hidden_size, AllReduceFusionOp op)
{
...
void customLowPrecisionAllReduce(kernels::LowPrecisionAllReduceParams& params, nvinfer1::DataType dataType,
    AllReduceStrategyType strat, AllReduceFusionOp fusionOp, cudaStream_t stream)
{
    ...
    switch (dataType)
    {
    case nvinfer1::DataType::kFLOAT: lowPrecisionAllReduceDispatchType<float>(params, strat, stream); break;
    case nvinfer1::DataType::kHALF: lowPrecisionAllReduceDispatchType<half>(params, strat, stream); break;
#ifdef ENABLE_BF16
    case nvinfer1::DataType::kBF16: lowPrecisionAllReduceDispatchType<__nv_bfloat16>(params, strat, stream); break;
#endif
