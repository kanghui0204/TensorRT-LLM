...
constexpr int LP_ALLREDUCE_MAX_ELTS_IN_WORKSPACE = 64 * 1024 * 1024;
...
struct LowPrecisionAllReduceParams
{
    ...
    uint64_t* peer_barrier_ptrs_in[MAX_RANKS_PER_NODE];
    uint64_t* peer_barrier_ptrs_out[MAX_RANKS_PER_NODE];
    ...
    static LowPrecisionAllReduceParams deserialize(size_t tpSize, size_t tpRank, nvinfer1::DataType dataType,
        int token_num, int hidden_size, AllReduceFusionOp op);
    static LowPrecisionAllReduceParams deserialize_hier(size_t tpSize, size_t tpRank, nvinfer1::DataType dataType,
        int token_num, int hidden_size, AllReduceFusionOp op);
};
